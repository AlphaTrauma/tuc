...
<div class="uk-width-medium uk-float-right">
    ...
    <a href="{{ route('group.document', ['group' => $group, 'type' => 'protocol2']) }}" class="uk-button uk-button-text uk-button-small  uk-margin-small">Скачать протоколы 2 <span uk-icon="download"></span></a>
    ...
    <a href="{{ route('group.document', ['group' => $group, 'type' => 'diary_pp']) }}" class="uk-button uk-button-text uk-button-small uk-margin-small">Скачать дневник практики ПП <span uk-icon="download"></span></a>
    <a href="{{ route('group.document', ['group' => $group, 'type' => 'diary_po']) }}" class="uk-button uk-button-text uk-button-small uk-margin-small">Скачать дневник практики ПО <span uk-icon="download"></span></a>
</div>

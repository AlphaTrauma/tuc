            ...
            <div class="uk-card uk-card-default uk-card-body">
                ...
                <div>
                    @foreach($user_course->user_blocks as $user_block)
                        <div>
                            ...
                            <ul class="uk-list uk-list-divider uk-margin-left">
                                @foreach($user_block->user_materials as $user_material)
                                    <li>
                                        @if($user_material->status) <span class="uk-text-success"
                                                                          uk-icon="check"></span>
                            ...
                            <progress class="uk-progress"
                                      uk-tooltip="Прогресс освоения блока {{ $user_block->user_materials->where('status', 1)->count() }}
                        ...
                        <a href="" hidden
                           class="uk-button uk-button-small uk-button-success uk-float-right">Приступить</a>

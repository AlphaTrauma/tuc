<footer class="uk-background-secondary uk-section-small uk-position-bottom">
        ...
        <div class="uk-flex uk-flex-between">
            <div class="uk-visible@s">
                <ul class="uk-nav uk-nav-default">
                    ...
                    <li>
                        <a href="#">Программы профессионального обучения</a>
                    </li>
                    <li>
                        <a href="#">Программы дополнительного образования</a>
                    </li>
                    <li>
            ...
            <div class="uk-visible@s">
                <ul class="uk-nav uk-nav-default">
                    ...
                    <li><a href="#">Структура и органы управления<br>образовательной деятельностью</a></li>
    ...
    <div class="uk-container">
        <div class="uk-float-right uk-flex uk-flex-center">
            <a class="uk-logo" href="#"><img style="max-height: 35px;" src="https://imageup.ru/img6/3890887/logo.png" alt=""></a>

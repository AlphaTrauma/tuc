...
class Group extends Model
{
    ...
    protected $fillable = ['contractor_id', 'end_date', 'start_date', 'number', 'contract', 'protocol',
        ...
        'chairman2', 'member3', 'member4', 'secretary2', 'chairman2_pos', 'member3_pos', 'member4_pos', 'secretary2_pos', 'course_id'];
    protected $dates = ['end_date', 'start_date'];

    public function users(){
        return $this->hasManyThrough(User::class, UserGroups::class,   'group_id', 'id','id', 'user_id');
    }
